...
title: 'Campus Placement using Python'
pubDate: 2025-01-08
description: 'A Python-based campus placement system with advanced data analysis and automation capabilities.'
languages: ["python", "django", "postgresql", "pandas", "djangorest", "fastapi", "restapi", "datetime", "oop", "html", "css", "javascript", "bootstrap", "git"]
image:
  url: "/images/projects/campus-placement-python.webp"
